...
function Search({data,handelSearch}) {
  ...
  return (
    <div className=''>
       <div className='bg-[url("./src/assets/bg.jpg")] backdrop-blur-sm place-content-center bg-no-repeat flex flex-col justify-between w-screen border border-gray-400 h-screen bg-cover p-10'>
         <div className='place-items-center gap-8'>
           ...
           <img src={`./src/assets/${data ? data.weather[0].main : null}.png`} alt="" className='w-27 place-content-center'/>
         </div>
